...
<title><xsl:value-of select="/root/page/title"/> - <xsl:value-of select="/root/company"/> - <xsl:value-of select="/root/title"/></title>
</head>
<body>
	<div id="top">
		<div class="container">
	...
	<div id="page">
		<div class="container">
		<h2><xsl:value-of select="/root/page/title"/></h2>
		<xsl:value-of select="/root/page/content" disable-output-escaping="yes"/>
		</div>
	</div>
	<div id="footer">
		<div class="container">
